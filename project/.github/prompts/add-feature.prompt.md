...
Rules:
- Keep changes limited to `index.html`, `css/styles.css`, and `js/app.js` unless strictly necessary.
- Use semantic HTML and accessible controls.
- Use realistic internal banking terminology.
- Do not add new pages, modals, or complex architecture.

Output:
- A short change summary
- The exact files you modified
- Any quick manual test steps
